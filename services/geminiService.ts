...
// Frontend service - calls Gemini API
// In production: Uses Vercel API route to keep key secure
// In development: Calls Gemini directly (requires VITE_GEMINI_API_KEY)
...
export const tailorResume = async (
  ...
  try {
    if (isProduction) {
      // Production: Call the Vercel API route (keeps API key secure)

    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-center text-stone-500 dark:text-slate-400 text-sm mt-4">
          We need your feedback and suggestion to make it more better, feel free to reach us at{' '}
          <a
            href="https://wa.me/message/SBQP4JNPZE6ZC1"
            target="_blank"
            rel="noopener noreferrer"
            className="underline hover:text-stone-700 dark:hover:text-slate-200 transition-colors"
          >
            What's app
          </a>
          , Thank you
